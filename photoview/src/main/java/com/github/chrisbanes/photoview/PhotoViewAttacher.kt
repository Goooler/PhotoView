...
import com.github.chrisbanes.photoview.Util.checkZoomLevels
import com.github.chrisbanes.photoview.Util.hasDrawable
import com.github.chrisbanes.photoview.Util.isSupportedScaleType
import com.github.chrisbanes.photoview.Util.postOnAnimation
        ...
        if (!mImageView.isInEditMode) {
            ...
            onGestureListener = object : OnGestureListener {
                ...
                override fun onFling(
                    ...
                    mCurrentFlingRunnable = FlingRunnable(mImageView.context).also {
                        it.fling(
                    ...
                    override fun onFling(
                        ...
                        mSingleFlingListener?.let {
                            ...
                            return if (e1.pointerCount > SINGLE_TOUCH
                                ...
                                false
                            } else it.onFling(e1, e2, velocityX, velocityY)
                        }
                        return false
                    }
                })
            ...
            when (ev.action) {
                ...
                MotionEvent.ACTION_CANCEL, MotionEvent.ACTION_UP ->
                    ...
                    if (scale < mMinScale) {
                        displayRect?.let {
                            v.post(
                                AnimatedZoomRunnable(scale, mMinScale, it.centerX(), it.centerY())
                            )
                            handled = true
                        }
                        ...
                        displayRect?.let {
                            v.post(
                                AnimatedZoomRunnable(scale, mMaxScale, it.centerX(), it.centerY())
                            )
                            handled = true
                        }
                    }
